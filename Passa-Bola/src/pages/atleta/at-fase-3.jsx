...
const Fase3 = () => {
    return(
        <Structure>
            <div className="w-full text-sm my-12">
                ...
                <button className="w-full py-3 mt-2 bg-blue-500 text-white rounded-md font-medium flex items-center justify-center gap-2"></button>
            </div>
        </Structure>
    )
}
